...
function operationFormatter(value,row,index){
	 ...
	 html +="<span onclick='baseData_edit("+value+");' style='color: green;cursor: pointer;' class='glyphicon glyphicon-pencil'></span>&nbsp;&nbsp;&nbsp;";
	 html +="</shiro:hasPermission>"
	 html +="<shiro:hasPermission name='basicData:delete'>"
...
function baseData_add(){
	layer_show("新增基础数据","baseData/edit.do",800,500);
}
...
function baseData_edit(baseId){
	layer.open({
	  ...
	  maxmin :true,
	  area: ['800px', '500px'],
	  content: 'baseData/edit.do?baseId='+baseId
	});
}
...
function baseData_del(baseId){
	layer.confirm('确认要删除吗？',{icon: 3},function(index){
		...
		//使用ajax 执行删除操作
		//$.get("admin/delete.do",{baseId:baseId},function(data){})
