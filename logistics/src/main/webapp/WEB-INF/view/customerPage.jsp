...
function operationFormatter(value,row,index){
	 ...
	 html +="<span onclick='customer_edit("+value+");' style='color: green;cursor: pointer;' class='glyphicon glyphicon-pencil'></span>&nbsp;&nbsp;&nbsp;";
...
function customer_add(){
	layer_show("新增客户","customer/edit.do",800,500);
}
...
function customer_del(customerId){
	layer.confirm('确认要删除吗？',{icon: 3},function(index){
		...
		//使用ajax 执行删除操作
		//$.get("admin/delete.do",{customerId:customerId},function(data){})
